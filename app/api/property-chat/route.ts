  ...
  try {
    ...
    const analysisData = {
      ...
      structuredData: {
        ...
        valleyLength: 0,
        complexity:
          propertyData.roofDetails.roofFacets > 6
            ? "complex"
            : propertyData.roofDetails.roofFacets > 3
              ? "moderate"
              : "simple",
        confidence: "medium",
        ...
        roofAreaRange: [
          propertyData.roofDetails.roofArea * 0.9,
          propertyData.roofDetails.roofArea * 1.1
        ],
        facetCountRange: [
          propertyData.roofDetails.roofFacets,
          propertyData.roofDetails.roofFacets
        ],
        squaresRange: [
          Math.floor(propertyData.roofDetails.roofArea / 100),
          Math.ceil(propertyData.roofDetails.roofArea / 100)
        ]
      }
    }
