  ...
  return (
    <div className="flex h-full items-center justify-center bg-gray-950 p-8">
      <div className="max-w-lg text-center">
        ...
        {/* Title */}
        <h1 className="text-3xl font-bold text-white">Rooftops AI Agent</h1>
        ...
        <div className="mt-8 space-y-3 text-left">
          ...
          <FeatureItem>Generate reports and send them to your team</FeatureItem>
          <FeatureItem>
            Manage customer communications and follow-ups
          </FeatureItem>
          <FeatureItem>Check weather forecasts for job scheduling</FeatureItem>
          <FeatureItem>Execute complex multi-step business tasks</FeatureItem>
        </div>

        {/* CTA */}
        <div className="mt-8">
          <Link href="/pricing">
            <Button className="h-12 bg-gradient-to-r from-[#ffd700] via-[#ffb700] to-[#ff8c00] px-8 text-lg font-semibold text-white hover:from-[#ffb700] hover:via-[#ff8c00] hover:to-[#ffd700]">
              <IconCrown
