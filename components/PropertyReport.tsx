              ...
              <div className="rounded-lg bg-gray-800 p-4">
                ...
                {property?.bedrooms && (
                  <p className="text-sm text-gray-300">
                    ...
                    {property.bedrooms}bd / {property.bathrooms || "N/A"}ba
                  </p>
                )}
              </div>
              ...
              {data.enhancedAnalysis?.structuredData && (
                <div className="rounded-lg bg-gray-800 p-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <p className="mb-2 text-sm text-gray-300">
                        <span className="font-medium">Roof Facets:</span>{" "}
                      ...
                      <p className="mb-2 text-sm text-gray-300">
                        ...
                        {data.enhancedAnalysis.structuredData.roofArea
                          ? `${data.enhancedAnalysis.structuredData.roofArea} sq ft`
                          : "N/A"}
                      </p>
                    </div>
                    <div>
                      ...
                      <p className="mb-2 text-sm text-gray-300">
                        ...
                        {data.enhancedAnalysis.structuredData.confidence ||
                          "N/A"}
                      </p>
                    </div>
                  </div>
            ...
            <div className="rounded-lg bg-gray-800 p-4">
              ...
              {solar?.potential ? (
                <div className="space-y-3">
                  <p className="text-sm text-gray-300">
                    <span className="font-medium">Solar Rating:</span>{" "}
                    {solar.rating || "N/A"}
                  </p>
                  <p className="text-sm text-gray-300">
                    <span className="font-medium">Estimated Capacity:</span>{" "}
                    {solar.capacity ? `${solar.capacity} kW` : "N/A"}
                  </p>
                  <p className="text-sm text-gray-300">
                  ...
                  <p className="text-sm text-gray-300">
                    <span className="font-medium">Roof Coverage:</span>{" "}
                    {solar.coverage ? `${solar.coverage}%` : "N/A"}
                  </p>
                  <p className="text-sm text-gray-300">
                    <span className="font-medium">Optimal Panel Count:</span>{" "}
                    {solar.optimalPanels || "N/A"}
                  </p>
                </div>
              ) : (
                <p className="text-sm text-gray-300">
                  Solar potential data not available.
                </p>
              )}
            </div>
          </TabsContent>
            ...
            <div className="rounded-lg bg-gray-800 p-4">
              ...
              {financial ? (
                <div className="space-y-3">
                  ...
                  <p className="text-sm text-gray-300">
                    <span className="font-medium">20-Year ROI:</span>{" "}
                    {financial.roi ? `${financial.roi}%` : "N/A"}
                  </p>
                  {financial.incentives && (
                    <p className="text-sm text-gray-300">
                      <span className="font-medium">Available Incentives:</span>{" "}
                      {financial.incentives}
                    </p>
                  )}
                </div>
